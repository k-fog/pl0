...
assert 6 'return (5-2)*2.'
assert 1 'return 10%3.'
assert 1 'if 1=1 then return 1.'
assert 1 'if 1<2 then return 1.'
assert 1 'if 1<=1 then return 1.'
assert 1 'if 1>0 then return 1.'
assert 1 'if 10>=8 then return 1.'
assert 0 'if 1<>1 then return 1 else return 0.'
assert 0 'if 1>2 then return 1 else return 0.'
...
assert 5 'begin x := 5; return x; end.'
assert 7 'if odd 3 then return 7 else return 0.'
assert 7 'if odd 30 then return 1 else return 7.'
